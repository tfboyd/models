...
def run_imagenet_with_keras(flags_obj):
  ...
  model_checkpoint_callback = tf.keras.callbacks.ModelCheckpoint(filepath=flags_obj.model_dir)
  tesorboard_callback = tf.keras.callbacks.TensorBoard(log_dir=flags_obj.model_dir)
